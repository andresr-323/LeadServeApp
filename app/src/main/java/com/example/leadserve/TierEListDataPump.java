...
public class TierEListDataPump{
    public static HashMap<String, List<String>> getData(tierOne t1, tierTwo t2, tierThree t3) {
        ...
        if(t1.getCoachingProgram() == 2){
            tier1.add("Complete");
        }else if(t1.getCoachingProgram() == 1){
            tier1.add("Under Review");
        }else{
            tier1.add("Not Complete");
        }
        ...
        if(t2.getLegacyProjectProp() == 2){
            tier2.add("Complete");
        }else if(t2.getLegacyProjectProp() == 1){
            tier2.add("Under Review");
        }else{
            tier2.add("Not Complete");
        }
        ...
        if(t3.getLeadershipLegProj() == 2){
            tier3.add("Complete");
        }else if(t3.getLeadershipLegProj() == 1){
            tier3.add("Under Review");
        }else{
            tier3.add("Not Complete");
        }
        ...
        if(t3.getLeadershipPort() == 2){
            tier3.add("Complete");
        }else if(t3.getLeadershipPort() == 1){
            tier3.add("Under Review");
        }else{
            tier3.add("Not Complete");
        }
