...
public class tierTwoAdapter extends ArrayAdapter<tierTwo> {
    private ArrayList<tierTwo> dataSet;
    Context mContext;
    ...
    public tierTwoAdapter(ArrayList<tierTwo> data, Context context) {
        super(context, R.layout.list_tier2, data);
        this.dataSet = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tierTwo dataModel = getItem(position);
        ...
        String s1 = String.valueOf(dataModel.getFivehour());
        String s2 = String.valueOf(dataModel.getLegacyProjectProp());
        String s3 = String.valueOf(dataModel.getLEAD2000());
